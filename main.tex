...
the sort-order failure above. Given the mesh, we reach $36.99$ dB PSNR on Shiny-Blender, above the
best reported results, and render at $76.8$ FPS on a consumer RTX 4090 with a $1.74$ GB footprint. Because the anchoring is linear in the vertices, appearance
