...
\begin{minipage}[t]{0.48\textwidth}
\centering
\caption{\textbf{Mesh refinement.} Means over the six Shiny-Blender scenes, from Ref-GS
marching-cubes extractions, without $\rightarrow$ with refinement. Normal error (VN: vertex, GN:
geometric) is measured against ground-truth normal maps over the test views. PSNR is a control, not
...
\midrule
VN MAE ($^\circ$)$\downarrow$    & $6.31 \rightarrow 5.41$     & $-14.2\%$ \\
GN MAE ($^\circ$)$\downarrow$    & $7.20 \rightarrow 5.88$     & $-18.3\%$ \\
