...
To our knowledge this is the first splat representation developed as an element-wise
texture that is differentiable and defined directly on the manifold, rather than as a
distribution in ambient $\mathbb{R}^3$.
