...
The mesh is fixed; only the appearance on it is optimized. Sec.~\ref{sec:refinement} then describes one downstream task the baked asset supports, which does
not alter the pipeline above.
