...
% The mesh is fixed; only the appearance on it is optimized. Sec.~\ref{sec:downstream} then describes two downstream tasks the baked asset supports, neither of
