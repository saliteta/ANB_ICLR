...
$\mathbf{G}_{\mathbf{C}}$ lives in the ambient space the anchoring excludes, and is read rather than
stepped: integrating it would carry the disks off the surface. It pulls back through the adjoint of
the anchoring,
%
\begin{equation}
\mathbf{G}_{\mathbf{V}} = \mathbf{D}^{-1}\mathbf{B}^{\top}\mathbf{G}_{\mathbf{C}},
