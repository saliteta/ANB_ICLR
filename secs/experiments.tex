...
sweep $\varepsilon\in\{10^{-5},10^{-4},10^{-3}\}$ on two representative scenes, \emph{ball} and
\emph{helmet}. Table~\ref{tab:ordering} shows PSNR is flat across three orders of magnitude of
