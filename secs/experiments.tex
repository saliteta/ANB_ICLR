...
DNR blur them and RefGS recovers them less crisply. Against the best context method per scene, our
margin is smallest on \emph{teapot} ($+0.45$~dB) and \emph{coffee} ($+0.72$~dB)
