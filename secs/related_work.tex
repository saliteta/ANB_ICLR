...
\cite{neumesh} is relevant in a sense that it binds learnable codes on the vertices, but never allow the code representation to float inside the 2D manifold. 
